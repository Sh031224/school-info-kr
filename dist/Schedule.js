...
var schedule = function (schoolId, officeCode, date) { return __awaiter(void 0, void 0, void 0, function () {
    var scheduleApi, scheduleList, scheduleData, i;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1.default.get("http://open.neis.go.kr/hub/SchoolSchedule", {
                    params: {
            ...
            case 1:
                ...
                scheduleList = [];
                scheduleData = scheduleApi.data.SchoolSchedule[1].row;
